...
public class LabTechnician {
	...
	public void deleting_exists_patient_using_search() throws Exception {
		Thread.sleep(1000);
		driver.findElement(By.id("frst_nm")).sendKeys("Demolabtechnician");
		Thread.sleep(2000);
...
//		}
	...
	public void user_enter_the_transaction_amount_then_receipt_comment_will_be_visible() throws Exception {
		// entering the amount
		driver.findElement(By.id("advance_field")).sendKeys("100");
		Thread.sleep(2000);
	}
...
////		driver.findElement(By.xpath("/html/body/main/div/div[12]/div/div[2]/form/div[2]/input")).click();
////		Thread.sleep(20000);
//	}
//
...
//	}
	...
	public void click_on_the_labtechnician_role() throws Exception {
		...
		driver.findElement(By.xpath("/html/body/main/div/div[2]/div/div[2]/a[6]/div/div/div/div[2]")).click();
		Thread.sleep(2000);
	}
...
//		driver.findElement(By.cssSelector("tbody>tr>td>a:nth-of-type(1)")).click();
	...
	public void upload_the_reports_by_clicking_on_the_upload_reports() throws Exception {
		...
		driver.findElement(By.id("files_constr"))
				.sendKeys("C:\\Users\\Lenovo\\OneDrive\\Desktop\\Uploads\\MedicalCondition.pdf");
		Thread.sleep(1000);
		// save
...
//		Thread.sleep(2000);
	...
	public void deleting_the_recently_added_test_and_saving() throws Exception {
		// deleting the test = FBS
		driver.findElement(By.xpath("//table[@id='example']/tbody/tr[3]/td[7]/a/i")).click();
		Thread.sleep(1000);
		// clicking on the yes
...
//		// selecting the readings radio button
//		WebElement detected = driver.findElement(By.xpath("(//label[text()='Detected'])[1]"));
//		detected.click();
//		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		// units
...
//	public void clicking_on_the_lab_test_masters() throws Exception {
//		// clicking on the lab masters
//		driver.findElement(By.id("lab_masters")).click();
//		Thread.sleep(3000);
//	}
//
//	@And("click on the tests and searching ECG")
//	public void click_on_the_tests_and_searching_ecg() throws Exception {
...
//		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(20));
//		driver.findElement(By.xpath("//li[text()='ECG'][1]")).click();
//		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(20));
//		// search
...
//	}
	...
	public void selecting_the_pathologist_role_from_the_roles() throws Exception {
		...
		driver.findElement(By.xpath("(//div[@class='col s3 m2'])[7]")).click();
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(20));
	}
	...
	public void clicking_on_the_digitalized_status_from_the_dashborad() throws Exception {
		// clicking on the digitalized
		driver.findElement(By.cssSelector("ul.tabs.card>li:nth-of-type(4)>a")).click();
		Thread.sleep(2000);
	}
...
//		Thread.sleep(3000);
	...
	public void select_the_clinic_manager_profile_nh_ip_op() throws Exception {
		driver.findElement(By.xpath("(//div[@class='col s3 m2'])[3]")).click();
		Thread.sleep(2000);
	}
...
//		Thread.sleep(3000);
	...
	public void clicking_on_the_labtechnician_role() throws Exception {
		// clickin on the labtechnician role
		driver.findElement(By.xpath("(//div[@class='col s3 m2'])[6]")).click();
		Thread.sleep(5000);
	}
...
//		Thread.sleep(1000);
		driver.findElement(By.id("admin-dashboard")).click();
		Thread.sleep(2000);
		// clicking on the manage reports
		driver.findElement(By.id("labTechOrders")).click();
		Thread.sleep(1000);
//		driver.findElement(By.id("q_appointment_id_cont")).sendKeys("854296");
//		Thread.sleep(2000);
//		driver.findElement(By.xpath("(//input[@value='Search'])[1]")).click();
//		Thread.sleep(2000);
//		// reset
